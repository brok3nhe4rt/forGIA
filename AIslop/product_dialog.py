...
class Ui_ProductDialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        if self.articul:
            self.lbl_id.setText(f"<b>Редактирование товара ID: {self.articul}</b>")
            self.load_product_info()
        else:
            self.lbl_id.setText(f"<b>Регистрация нового товара</b>")
        ...
        try:
            ...
            for p in products:
                if str(p['articul']) == str(self.articul):
                    ...
                    self.desc_input.setText(p.get('huy', ''))
    ...
    def choose_image(self):
        try:
            ...
            if file_path:
                ...
                # Создаем папку AIslop в ТОЙ ЖЕ директории, где и программа
    ...
    def save_data(self):
        try:
            ...
            data = {
                ...
                'huy': self.desc_input.text().strip(),
